...
WINHTTPAPI ULONG       WINAPI HttpWaitForDisconnect(HANDLE,HTTP_CONNECTION_ID,LPOVERLAPPED);
WINHTTPAPI ULONG       WINAPI HttpWaitForDisconnectEx(HANDLE,HTTP_CONNECTION_ID,ULONG,LPOVERLAPPED);

WINHTTPAPI ULONG       WINAPI HttpAddFragmentToCache(HANDLE,LPCWSTR,PHTTP_DATA_CHUNK,ULONG,PHTTP_CACHE_POLICY,PVOID);
WINHTTPAPI ULONG       WINAPI HttpFlushResponseCache(HANDLE,LPCWSTR,ULONG,LPOVERLAPPED);
