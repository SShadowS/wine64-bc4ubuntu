...
#define IOCTL_HTTP_WAIT_FOR_DISCONNECT CTL_CODE(FILE_DEVICE_UNKNOWN, 0x80D, METHOD_BUFFERED, 0)
...
#define IOCTL_HTTP_WAIT_FOR_DISCONNECT_EX CTL_CODE(FILE_DEVICE_UNKNOWN, 0x80E, METHOD_BUFFERED, 0)
